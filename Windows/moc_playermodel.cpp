...
#include "../../uno/ui/interface/src/playermodel.h"
...
void PlayerModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        PlayerModel *_t = static_cast<PlayerModel *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PlayerModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_PlayerModel.data,
      qt_meta_data_PlayerModel,  qt_static_metacall, nullptr, nullptr}
};
